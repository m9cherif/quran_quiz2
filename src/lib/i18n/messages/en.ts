...
const en: Messages = {
    ...
    auth: {
      ...
      codeIntro: "We email you a code — no password to remember.",
      sendCode: "Email me a code",
      codeSentTo: "We sent a code to {email}.",
      codeLabel: "The code from the email",
      codeWrong: "That code is wrong or has expired. Check the email, or ask for a new one.",
      codeExpired: "That code has expired. Ask for a new one.",
      codeTooShort: "Enter the whole code from the email.",
      resendCode: "Send it again",
      resendIn: "Send again in {seconds}s",
      changeEmail: "Use another address",
      emailInvalid: "Enter a valid email address.",
      noAccountForEmail: "No account uses this address. Create one first.",
