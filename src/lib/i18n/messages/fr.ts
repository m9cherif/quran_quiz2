...
const fr: Messages = {
    ...
    auth: {
      ...
      codeIntro: "Nous vous envoyons un code à six chiffres — aucun mot de passe à retenir.",
      sendCode: "M'envoyer un code",
      codeSentTo: "Nous avons envoyé un code à six chiffres à {email}.",
      codeLabel: "Le code reçu par e-mail",
      codeWrong: "Ce code n'est pas le bon. Vérifiez l'e-mail et réessayez.",
      codeExpired: "Ce code a expiré. Demandez-en un nouveau.",
      codeTooShort: "Le code comporte six chiffres.",
      resendCode: "Renvoyer",
