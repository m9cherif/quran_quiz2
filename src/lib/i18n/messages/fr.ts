...
const fr: Messages = {
    ...
    auth: {
      ...
      codeIntro: "Nous vous envoyons un code par e-mail — aucun mot de passe à retenir.",
      sendCode: "M'envoyer un code",
      codeSentTo: "Nous avons envoyé un code à {email}.",
      codeLabel: "Le code reçu par e-mail",
      codeWrong: "Ce code est incorrect ou expiré. Vérifiez l'e-mail, ou demandez-en un nouveau.",
      codeExpired: "Ce code a expiré. Demandez-en un nouveau.",
      codeTooShort: "Entrez le code complet reçu par e-mail.",
      resendCode: "Renvoyer",
      resendIn: "Renvoyer dans {seconds} s",
      changeEmail: "Utiliser une autre adresse",
      emailInvalid: "Entrez une adresse e-mail valide.",
      noAccountForEmail: "Aucun compte n'utilise cette adresse. Créez-en un d'abord.",
