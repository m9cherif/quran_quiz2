...
const ar: Messages = {
    ...
    auth: {
      ...
      codeIntro: "نرسل إليك رمزًا من ستة أرقام — لا كلمة مرور تحفظها.",
      sendCode: "أرسل لي رمزًا",
      codeSentTo: "أرسلنا رمزًا من ستة أرقام إلى {email}.",
      codeLabel: "الرمز الوارد في البريد",
      codeWrong: "الرمز غير صحيح. راجع البريد وحاول مجددًا.",
      codeExpired: "انتهت صلاحية الرمز. اطلب رمزًا جديدًا.",
      codeTooShort: "الرمز مكوّن من ستة أرقام.",
