...
const ar: Messages = {
    ...
    quick: {
      joinDesc: "أدخل الرمز، أو اختر لعبة مفتوحة الآن.",
      classesDesc: "صفوفك والألعاب التي أقامها معلمك.",
    ...
    classGames: {
      ...
      none: "لم يقم هذا الصف بأي لعبة بعد.",
      live: "مفتوحة الآن",
      enter: "دخول",
      rejoin: "العودة",
      results: "النتائج",
