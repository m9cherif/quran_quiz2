...
const ar: Messages = {
    ...
    auth: {
      ...
      codeIntro: "نرسل إليك رمزًا إلى بريدك — لا كلمة مرور تحفظها.",
      sendCode: "أرسل لي رمزًا",
      codeSentTo: "أرسلنا رمزًا إلى {email}.",
      codeLabel: "الرمز الوارد في البريد",
      codeWrong: "الرمز غير صحيح أو انتهت صلاحيته. راجع البريد أو اطلب رمزًا جديدًا.",
      codeExpired: "انتهت صلاحية الرمز. اطلب رمزًا جديدًا.",
      codeTooShort: "أدخل الرمز كاملًا كما ورد في البريد.",
      ...
      noAccountForEmail: "لا يوجد حساب بهذا البريد. أنشئ حسابًا أولًا.",
